...
> [!TIP]
> 🆕 <strong>2026-06-04 · README Refresh and ThinkFlow Branding</strong><br>
> Refreshed the README in a Paper2Any-style structure with a new ThinkFlow logo, feature matrix, showcase sections, and a clearer local startup guide.

> [!TIP]
> 🆕 <strong>2026-06-02 · Multimodal Retrieval Merge</strong><br>
> Integrated <strong>VLM mode</strong>, image attachments, pasted-image prompts, PDF image extraction/gallery, visual embedding configuration, and multimodal source processing into the ThinkFlow workspace.
...
> ThinkFlow turns a notebook into a source-grounded knowledge production loop: sources enter once, conversations refine understanding, confirmed knowledge is saved, and final outputs are generated from locked context.
...
- **📄 Report generation**: produce Markdown/PDF-style reports from sources, documents, and guidance.
- **🗺️ Mindmap generation**: turn source material into navigable hierarchical maps with export options.
- **🎞️ PPT workflow**: generate outlines, review slide-by-slide content, and produce presentation outputs from locked source context.
- **🎧 Podcast generation**: generate scripts and audio for listening-oriented review.
- **🧩 Learning outputs**: create flashcards and quizzes for course review, onboarding, and knowledge checks.
- **🎬 Video generation**: create storyboard, narration, and video outputs from source material and generated scripts.
...
<table>
  <tr>
    <td width="50%" align="center" valign="top">
      ...
      <br><sub>✨ Add files, text, URLs, search results, and deep-research materials into one notebook</sub>
    </td>
    <td width="50%" align="center" valign="top">
